...
- (void)viewDidLoad
{
    ...
    _firstTitleLabel.text = @"PA设置";
}

- (IBAction)personSettings
{
    ...
    PersonSettingsViewController *viewController = [[PersonSettingsViewController alloc] initWithNibName:@"PersonSettingsViewController" bundle:nil];
